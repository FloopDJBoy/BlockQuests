...
public class GreaterThanBlock extends Expression<Boolean> {
    private final ExpressionInput first, second;

    public GreaterThanBlock() {
        super("GreaterThanBlock", Boolean.class, Category.OPERATORS);
        DummyInput input = new DummyInput(this).addField(new LabelField(this, ">"));
