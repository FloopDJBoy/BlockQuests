...
public class ModuloBlock extends Expression<Integer> {
    private final ExpressionInput first, second;

    public ModuloBlock() {
        super("ModuloBlock", Integer.class, Category.OPERATORS);
        DummyInput input = (DummyInput) new DummyInput(this).addField(new LabelField(this, "mod"));
